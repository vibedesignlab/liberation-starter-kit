...
- accepted `extended-brand-anatomy.html` and `.json`;
...
After section 6, render an unnumbered `data-review-checkpoint` block. Do not add a page implementation chapter.
